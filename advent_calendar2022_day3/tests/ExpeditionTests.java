...
public class ExpeditionTests {
    ...
    @Test
    void shouldCalculateTotalPriorityForRucksacksCorrectly() {
        RucksacksIdentifier identifier = new RucksacksIdentifier(shortInput);

        Expedition expedition = new Expedition(identifier.getRucksacks());
        assertEquals(157, expedition.getTotalExpeditionPriorities());
    }

    @Test
    void shouldCalculateTotalPriorityCorrectlyForLargeInputOfRucksacks() {
        RucksacksIdentifier identifier = new RucksacksIdentifier(longInput);

        Expedition expedition = new Expedition(identifier.getRucksacks());
        assertEquals(8233, expedition.getTotalExpeditionPriorities());
    }

    @Test
    void shouldCalculateTotalPriorityForElfGroupCorrectly() {
        RucksacksIdentifier identifier = new RucksacksIdentifier(shortInput);

        Expedition expedition = new Expedition(identifier.getRucksacks());
        assertEquals(70, expedition.getTotalElfGroupsPriorites());
    }

    @Test
    void shouldCalculateTotalPriorityForElfGroupCorrectlyWithLongInput() {
        RucksacksIdentifier identifier = new RucksacksIdentifier(longInput);

        Expedition expedition = new Expedition(identifier.getRucksacks());
        assertEquals(2821, expedition.getTotalElfGroupsPriorites());
    }
}
